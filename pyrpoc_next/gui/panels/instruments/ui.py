"""Pure-layout for the instrument manager. No backend coupling.

Ported verbatim from the original ``pyrpoc`` instrument manager so the panel looks
identical; only the widget/handler glue is rewired to the new backend.
"""
