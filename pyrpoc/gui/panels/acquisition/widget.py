...
from pyrpoc.gui.panels.acquisition.handlers import (
...
from pyrpoc.gui.panels.acquisition.ui import build_acquisition_manager_ui
from pyrpoc.gui.services.acquisition_service import AcquisitionService


class AcquisitionManagerWidget(QWidget):
    def __init__(self, modality_service: AcquisitionService, parent: QWidget | None = None):
