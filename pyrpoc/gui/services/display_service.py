...
from pyrpoc.structs.parameters import ParameterValidationError, ParameterValue, coerce_parameter_values
from pyrpoc.structs.rpoc_image import RPOCImageInput
...
class DisplayService(QObject):
    ...
    def create_display(
        ...
        *,
        ...
        widget.user_label = (
            user_label if isinstance(user_label, str) and user_label.strip()
            else getattr(widget, "user_label", None)
        )
