...
parameter_groups = {
    ...
    "daq": [
        ...
        NumberParameter(label="Sample Rate (Hz)", default=100_000.0, minimum=1.0, maximum=5_000_000.0, step=1_000.0, tooltip="DAQ sample rate in Hz", number_type=float),
        ...
        ChannelSelectionParameter(label="Active AI Channels", num_channels=9, tooltip="Toggle which analog input channels are active"),
    ],
    "acquisition": [
        NumberParameter(label="t0 Samples", default=1, minimum=1, tooltip="Number of samples in the first subpixel window", number_type=int),
        NumberParameter(label="t1 Samples", default=0, minimum=0, tooltip="Number of samples to discard between t0 and t2", number_type=int),
        ...
        PathParameter(label="save_path", display_label="save_path", default="acquisition", required=False, tooltip="Base name/path for saved TIFF files (e.g. /dir/acquisition)"),
